export function About() {
    return <section className="about">
        ...
        <p>This innovative application is designed to seamlessly integrate two indispensable tools from Google - Gmail and Google Keep. AppSus brings together the power of email communication and note-taking into a unified platform, offering a wide array of features and functionalities tailored to meet the diverse needs of our users.</p>
        <p>AppSus is more than just a combination of Gmail and Google Keep; it's a holistic solution that encourages productivity, organization, and efficiency in the digital age. Our commitment to providing a user-friendly interface and continuous updates means you can expect a dynamic and evolving tool that adapts to your evolving needs.</p>
